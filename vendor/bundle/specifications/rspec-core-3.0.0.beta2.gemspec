# -*- encoding: utf-8 -*-
# stub: rspec-core 3.0.0.beta2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.summary = "rspec-core-3.0.0.beta2"
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rspec_spinner>, ["= 2.0.0"])
      ...
      s.add_dependency(%q<rspec_spinner>, ["= 2.0.0"])
